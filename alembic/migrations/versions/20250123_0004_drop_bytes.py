"""Drop file1_bytes and file2_bytes columns

Revision ID: 20250123_0004_drop_bytes
...
revision: str = '20250123_0004_drop_bytes'
...
def upgrade() -> None:
    ...
    Данные уже перенесены на диск (файлы .xlsx), эти колонки больше не нужны.
    """
...
def downgrade() -> None:
    """
    Восстанавливает колонки file1_bytes и file2_bytes (если потребуется откат).
    Внимание: данные в колонках будут NULL, так как файлы хранятся только на диске.
    """
