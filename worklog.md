...
Task ID: Refactor global state to service classes

- Создан TaskStateService для управления состоянием задач
- Создан LockManager для асинхронных блокировок
- Обновлён bot/_state.py для обратной совместимости
